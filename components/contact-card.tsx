...
export function ContactCard() {
	...
	return (
		<GlassSurface
			...
			displace={1.5}
		>
			<div className="w-full flex-col p-4 sm:p-6">
				{/* Mac App Top Bar */}
				<div className="mb-10 flex flex-col justify-between gap-6 pb-6 lg:flex-row lg:items-center">
					...
					<div className="flex items-center justify-between gap-6 text-xs text-white/80 sm:justify-end sm:text-sm">
						<a
					...
					>
						<div className="grid grid-cols-1 gap-5 md:grid-cols-2">
							<Field data-invalid={!!errors.name}>
								...
								<Input
									...
									className="bg-background/40! backdrop-blur-xl"
						...
						<Field data-invalid={!!errors.message}>
							...
							<Textarea
								...
								className="resize-none bg-background/40! backdrop-blur-xl"
